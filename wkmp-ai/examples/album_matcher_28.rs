/// Comprehensive Album Matcher - Run 28: Parameter Reordering Optimization
///
/// Run 28 optimizes Stage 2 parameter testing by reordering parameters by empirical
/// likelihood and adding early-exit logic for 100% matches.
/// Based on Run 27 (edition ranking enhancement).
///
/// Parameter Ordering Enhancement (Phase 1 Validation - PLAN027):
/// - Reordered 180-parameter grid by empirical frequency from Run 27 (193 successful albums)
/// - Test most-likely parameters first (e.g., -50dB/3.0s, -50dB/2.0s, -50dB/0.5s)
/// - Early-exit immediately when 100% match found (no need to test remaining params)
/// - Partial matches continue testing all 180 parameters (no regression)
///
/// Performance Impact:
/// - 169 albums (87.6%) achieve 100% match and benefit from early-exit
/// - Mean exit rank: 10.7 params (vs 180 tested in Run 27)
/// - Median exit rank: 4.0 params (57.4% exit in first 5 attempts)
/// - Expected savings: ~0.35s per album average
/// - Zero downside: Partial matches unchanged
///
/// Empirical Rationale:
/// - Top 5 parameter combinations account for 55.4% of successful matches
/// - Top 20 combinations account for 78.8% of successful matches
/// - Testing likely parameters first maximizes early-exit benefit
///
/// See: wip/PLAN027_album_matcher_simplicity_first/PHASE1_VALIDATION_REPORT.md
///
/// Inherited from Run 27:
/// - Edition ranking enhancement (quality over track count)
...
// See: wip/PLAN027_album_matcher_simplicity_first/PHASE1_VALIDATION_REPORT.md Appendix A
//
// Frequency by threshold (in top 20 combinations):
//   -50dB: appears in 7 of top 20 (ranks 1,2,3,5,11,15,17) - 104 albums (53.9%)
//   -58dB: appears in 6 of top 20 (ranks 4,6,7,8,18,19) - 30 albums (15.5%)
//   -60dB: appears in 3 of top 20 (ranks 9,10,12) - 10 albums (5.2%)
//   -62dB: appears in 2 of top 20 (ranks 13,14) - 6 albums (3.1%)
//   -56dB, -52dB: appear in 1 each - 4 albums total (2.1%)
//   -54dB, -48dB, -40dB, -38dB, -34dB, -30dB: not in top 20 - rare
//
