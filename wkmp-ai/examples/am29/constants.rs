...
// =============================================================================
// Stage 4 Artist Gating Constants (Run 29)
// =============================================================================

/// Minimum artist similarity required to use Stage 4 (Layer 1: Pre-filter gate)
/// Below 40% artist similarity, Stage 4 is skipped entirely - timing match is likely false positive
pub(crate) const STAGE4_MIN_ARTIST_SIMILARITY: f64 = 0.40;

/// Weight for timing match in composite score (Layer 2)
/// 60% of final score comes from track timing match
pub(crate) const STAGE4_TIMING_WEIGHT: f64 = 0.60;

/// Weight for artist similarity in composite score (Layer 2)
/// 30% of final score comes from artist name similarity
pub(crate) const STAGE4_ARTIST_WEIGHT: f64 = 0.30;

/// Weight for album similarity in composite score (Layer 2)
/// 10% of final score comes from album name similarity
pub(crate) const STAGE4_ALBUM_WEIGHT: f64 = 0.10;

/// Maximum acceptance threshold when artist similarity is high (>= 80%)
/// High artist confidence allows acceptance of lower timing match percentages
pub(crate) const STAGE4_MAX_ACCEPTANCE_THRESHOLD: f64 = 50.0;

/// Minimum acceptance threshold when artist similarity is at gate level (40%)
/// Low artist confidence requires higher timing match percentages
pub(crate) const STAGE4_MIN_ACCEPTANCE_THRESHOLD: f64 = 85.0;
