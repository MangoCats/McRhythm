...
4) PROCESSING: Each file in the list is processed through the sequential stages identified in 4xN) with several files proceeding in parallel as optimal for the processor wkmp-ai is running on.
