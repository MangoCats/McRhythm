...
**Document ID:** SPEC031-data_driven_schema_maintenance.md
**Status:** Production Ready
**Created:** 2025-11-09
**Supersedes:** Manual migration pattern in wkmp-common/src/db/migrations.rs

> **Related Documentation:** [Requirements](REQ001-requirements.md) | [Database Schema](IMPL001-database_schema.md) | [Architecture](SPEC001-architecture.md)
...
**[REQ-NF-036]** Automatic database creation with default schema (REQ001-requirements.md)
**[REQ-NF-037]** Modules create missing tables/columns automatically (REQ001-requirements.md)
**[ARCH-DB-MIG-010]** Schema migration framework (wkmp-common/src/db/migrations.rs)
**[ARCH-DB-MIG-020]** Migration tracking via schema_version table (wkmp-common/src/db/migrations.rs)
**[ARCH-DB-MIG-030]** Idempotent migrations (safe to run multiple times) (wkmp-common/src/db/migrations.rs)

### New Requirements (defined in this specification)

**[ARCH-DB-SYNC-010]** Declarative schema definition via TableSchema trait
**[ARCH-DB-SYNC-020]** Automatic column addition via ALTER TABLE
**[ARCH-DB-SYNC-030]** Schema introspection and drift detection via PRAGMA table_info
